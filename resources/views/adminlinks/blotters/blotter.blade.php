...
<div class="py-6 px-2 bg-gray-50">
  <h1 class="mx-auto pb-6 text-center text-4xl font-medium text-gray-900 px-2">Add Blotter</h1>
  <div class="py-2 px-10 mx-auto max-w-screen-md rounded-lg border border-gray-300">
    <form method="POST" action="/dashboard/blotters/" enctype="multipart/form-data" class="mx-auto">
      @csrf
...
<textarea id="message" name="complaint" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your complain here...">{{old("complaint")}}
</textarea>
              @error('complaint')
                  <p class="text-red-500 text-xs mt-1">{{$message}}</p>
              @enderror
