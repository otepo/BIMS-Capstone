...
<div id="popup-modal1" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
  <div class="relative w-full max-w-md max-h-full">
    ...
    <div id="nonPrintable" class="py-6 px-2 bg-gray-50">
        <h1 class="mx-auto pb-6 text-center text-4xl font-medium text-gray-900 px-2">View and Update Resident Info</h1>
